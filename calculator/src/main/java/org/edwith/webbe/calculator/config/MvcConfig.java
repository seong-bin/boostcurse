...
@Configuration
@EnableWebMvc
// @EnableSwagger2어노테이션으로 인해 spring MVC와 swagger2의 기본 설정이 자동으로 됨
@EnableSwagger2
...
public class MvcConfig implements WebMvcConfigurer {
	    ...
	    Docket객체는 어떤 경로에 web api들을 자동으로 문서화 할것인지에 대한 설정과 문서 설명에 대한 내용이 필요
	     */
		@Bean
		public Docket api() {
...
//					.apis(RequestHandlerSelectors.basePackage("org.edwith.webbe.calculator.controller"))
		...
		private ApiInfo apiInfo() {
			Contact contact = new Contact("배성빈", "https://www.edwith.org", "carami@edwith.org");
			ApiInfo apiInfo =
